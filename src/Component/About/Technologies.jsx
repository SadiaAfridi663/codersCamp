  ...
  return (
    <section className="w-full bg-gradient-to-br from-primary-light via-white to-blue-50 py-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary rounded-full blur-3xl opacity-10 animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-dark rounded-full blur-3xl opacity-10 animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary rounded-full blur-3xl opacity-5 animate-pulse delay-500"></div>
      </div>
          ...
          >
            {filteredTechnologies.map((tech, index) => {
              ...
              return (
                ...
                >
                  {/* Tech Card */}
                  <div className={`flex flex-col items-center p-6 rounded-2xl bg-white border border-gray-200 shadow-lg transition-all duration-300 group-hover:border-primary/30 relative ${
                      ...
                      {hoveredTech === tech.name && (
                        ...
                        >
                          <motion.span
                            ...
                            className="text-xl font-bold text-primary text-center bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg"
                          >
                            {tech.name}
                          </motion.span>
                        </motion.div>
